...
JLabel heading = new JLabel("Enter Marks for student");
    ...
    JLabel lblsemester =new JLabel("Select Semster");
    lblsemester .setBounds(50,110,150,20);
    heading.setFont(new Font("serif",Font.PLAIN,20));
    add(lblsemester);


String semester[]={" ","1st semester","2nd semester","3rd semster","4th semster","5th semster","6th semster","7th semster","8th semster"};
...
tfmarks1.setBounds(256,200,200,20);
add(tfmarks1);

tfmarks2= new JTextField();
tfmarks2.setBounds(256,230,200,20);
add(tfmarks2);

tfmarks3= new JTextField();
tfmarks3.setBounds(256,260,200,20);
add(tfmarks3);

tfmarks4= new JTextField();
tfmarks4.setBounds(256,290,200,20);
add(tfmarks4);

tfmarks5= new JTextField();
tfmarks5.setBounds(256,320,200,20);
add(tfmarks5);
